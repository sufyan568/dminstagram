...
$(document).ready(function() {
  ...
  $(document).on('click','.delete_app',function(e){
    e.preventDefault();
     swal({
      ...
      text: google_app_delete_confirm,
      icon: 'warning',
      buttons: true,
      dangerMode: true,
    })
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          context: this,
          type:'POST' ,
          url:base_url+"social_apps/delete_app_google",
          dataType: 'json',
  ...
  $(document).on('click','.change_state',function(e){
    e.preventDefault();
     swal({
      title: global_lang_are_you_sure,
      text: google_app_status_change_confirm,
      icon: 'warning',
      buttons: true,
      dangerMode: true,
    })
    .then((willDelete) => {
      if (willDelete) 
      {
        ...
        $.ajax({
          context: this,
          type:'POST' ,
          url:base_url+"social_apps/change_app_status_google",
          dataType: 'json',
          data:{app_table_id : app_table_id},
          success:function(response){ 
