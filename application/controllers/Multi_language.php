...
class Multi_language extends Home
{
    ...
    public function ajax_get_language_details() 
    {
        ...
        $startform = '<script src="'.base_url().'assets/js/system/multilanguage_ajax_get_laguage_details.js"></script>
    ...
    public function ajax_get_lang_file_data_update()
    {
        ...
        if($finalType[0] == 'main-application') 
        {
            ...
            } else
            {
                ...
                foreach($alldata as $key=>$value) 
                {
                    $langForm .='<tr role="row" width="100%"><td class="width_50"><textarea class="form-control text_key" type="text" name="lang_index[]" class="form-control" readonly>' .$key. '</textarea></td><td class="width_50"><textarea type="text" class="form-control text_value" name="lang_data[]" class="form-control">' .$value. '</textarea></td></tr>';
                }
