...
class Simplesupport extends Home
{
    ...
    public function ticket_data()
    {
        ...
        $ticket_status = strip_tags($this->input->post("ticket_status",true));
        $order_by = "id DESC";
     
        $search = strip_tags($this->input->post('search',true));
        ...
        {  
            ...
            <div class="activity">
                ...
                <div class="activity-detail h-100 w-100">            
                  <div class="row align-items-center h-100">
                    <div class="col-3 col-md-1 mx-auto">
                        <img src="'.$logo.'" class="rounded-circle max_width_50px">
                    </div>
    ...
    public function open_ticket_action()
    {
        ...
        $data['ticket_text'] = strip_tags($ticket_text,$this->editor_allowed_tags);
    ...
    public function reply_action()
    {
       ...
       $data['ticket_reply_text']  = strip_tags($ticket_reply_text,$this->editor_allowed_tags);
       $data['user_id'] = $this->user_id;
