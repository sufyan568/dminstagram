...
{				
	...
	{	
		...
		$permissions = ['email','pages_show_list','public_profile','pages_manage_metadata','pages_read_engagement'];
	...
	**********/
	...
	public function enable_bot($page_id='',$post_access_token='')
	{
		...
		{
			$params=array();			
			$params['subscribed_fields']= array("mention");			
