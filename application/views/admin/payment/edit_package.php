                    ...
                    {  
                     ...
                     echo "<tr>"; 
                        ...
                        if(is_array($current_modules) && in_array($module['id'], $current_modules)) $check_module='checked';  ?>
                          ...
                          if(in_array($module['id'], $mandatory_modules)) $cssstyle = "border_color_6777EF cursor_pointer' title='".$this->lang->line('This is a mandatory module and can not be unchecked.')."' data-toggle='tooltip'";
                        ...
                        echo "<td align='center'>".$limit."</td><td align='center'><input type='number' ".$disabled."  class='form-control width_70px ".$cssstyle."' value='".$xmonthly_val."' min='0' name='monthly_".$module['id']."'></td>";
                        ...
                        echo "<td align='center'><input type='number'  class='form-control width_70px ".$cssstyle."' ".$disabled." value='".$xval."'  min='0' name='bulk_".$module['id']."'></td>";
                      echo "</tr>";                 
                    }                
                    ?>            
                  </table> 
