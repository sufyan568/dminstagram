	                   ...
	                   <?php                  
	                    ...
	                    {  
	                     ...
	                     echo "<tr>"; 
	                        ...
	                        echo "<td align='center'>".$limit."</td><td align='center'><input type='number' ".$disabled." class='form-control width_70px ".$cssstyle."' value='0' min='0' name='monthly_".$module['id']."'></td>";
