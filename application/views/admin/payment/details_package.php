                 ...
                 $SL++;
                  ...
                  echo "<tr>"; 
                    ...
                    if($module["limit_enabled"]=='0')
                    {
                      ...
                      $cssstyle='bg_ffffff border_none';
                    }
                    else
                    {
                        $disabled=" readonly";
                    ...
                    echo "<td align='center'>".$limit."</td><td align='center'><input type='text' ".$disabled." class='form-control width_70px ".$cssstyle."' value='".$xmonthly_val."' min='0' name='monthly_".$module['id']."'></td>";
                    ...
                    echo "<td align='center'><input type='text' class='form-control width_70px ".$cssstyle."' ".$disabled." value='".$xval."'  min='0' name='bulk_".$module['id']."'></td>";
                  echo "</tr>";                 
                }                
                ?>            
              </table> 
