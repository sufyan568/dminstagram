<section class="section">
	...
	<div class="row">
        <div class="col-12 col-md-6 col-lg-6">
            <div class="card">
              <div class="card-body">
                  <b><?php echo $this->lang->line("App Domain")."</b> : <span class='text-primary'>".get_domain_only(base_url()); ?></span><br/>
                  <b><?php echo $this->lang->line("Site URL")." :</b> <span class='text-primary'>".base_url(); ?></span><br/><br>
                  <b><?php echo $this->lang->line("Privacy Policy URL")." :</b> <span class='text-primary'>".base_url('home/privacy_policy');?></span><br/>
                  <b><?php echo $this->lang->line("Terms of Service URL")." :</b> <span class='text-primary'>".base_url('home/terms_use');?></span><br/><br>
                
                  <b><?php echo $this->lang->line("Webhook Callback URL")." :</b> <br><span class='text-primary'>".base_url('home/central_webhook_callback');?></span><br/>                  
                  <?php 
                  ...
                  ?>
                  <b><?php echo $this->lang->line("Webhook Verify Token")." :</b> <span class='text-primary'>".$this->config->item('central_webhook_verify_token');?></span><br/>
        ...
        <div class="col-12 col-md-6 col-lg-6">
            <div class="card">
              ...
              <div class="card-body min_height_165px">
                  
                  <b><?php echo $this->lang->line("Valid OAuth Redirect URI")." </b>: <br><br><span class='text-primary'>".base_url("home/facebook_login_back"); ?></span><br>
                  <span class='text-primary'><?php echo base_url('home/redirect_rx_link'); ?></span><br/>
                  <span class='text-primary'><?php echo base_url('social_accounts/manual_renew_account'); ?></span><br/>
