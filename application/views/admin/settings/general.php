		...
		<div class="section-body">
			...
			<div class="row">
				<div class="col-md-8">					
   					        ...
   					        <div class="row d-none">
   					           	<div class="col-12 col-md-6">
   					           		<div class="form-group">
   					           		  ...
   					           		  ?>
   					           		  <label class="custom-switch mt-2">
   					           		    <input type="checkbox" name="instagram_reply_enable_disable" value="1" class="custom-switch-input"  <?php if(1) echo 'checked'; ?>>
   					           		    <span class="custom-switch-indicator"></span>
					...
					<div class="card d-none" id="group-posting">
						<div class="card-header">
							<h4><i class="fas fa-share-square"></i> <?php echo $this->lang->line("Instagram Poster"); ?></h4>
						</div>
						<div class="card-body">
						    <div class="row">
						    	<div class="col-12">
						    		<div class="form-group">
						    		  ...
						    		  ?>
						    		  <label class="custom-switch mt-2">
						    		    <input type="checkbox" name="facebook_poster_botenabled_pages" value="1" class="custom-switch-input"  <?php if(0) echo 'checked'; ?>>
						    		    <span class="custom-switch-indicator"></span>
				              	    ...
				              	    <div class="form-group">
     				              	...
     				              	<div class="form-group">
    			             			...
    			             			<?php 
    				             			...
    				             			if($facebook_poster_video_upload_limit=="") $facebook_poster_video_upload_limit=100; 
    			             			?>
     			               			<input name="facebook_poster_video_upload_limit" value="<?php echo $facebook_poster_video_upload_limit;?>"  class="form-control" type="number" min="1" max="100">	
					...
					<div class="card" id="junk_data">
						...
						<div class="card-body">				       
			              <div class="row">
			              		<div class="col-12">
	 				              	<div class="form-group">
	 					             	<label for=""><i class="fa fa-calendar"></i> <?php echo $this->lang->line("Delete auto-reply report data, log data after how many days?");?></label>
				             			<?php 
