			...
			<div class="card-body">
				<div class="empty-state">
					<?php if(isset($expired_or_not) && $expired_or_not==1) : ?>
						<h5 class="text-center"><i class="fas fa-info-circle font_size_18px"></i> <?php echo $this->lang->line("User access token is valid. you can login and get new user access token if you want."); ?></h5>
					<?php endif; ?>
					<br/>
					...
					?>
						<img class="img-fluid height_300px" src="<?php echo base_url('assets/img/drawkit/drawkit-full-stack-man-colour.svg'); ?>" alt="image">
