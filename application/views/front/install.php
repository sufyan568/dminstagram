      ...
      <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3">
        ...
        <div class="col-12">
          ...
          if($this->session->userdata('mysql_error')!="")
            {
              echo "<pre class='m-0 text-center text-danger'><h6>";
              ...
              <form class="form-horizontal" action="<?php echo site_url().'home/installation_action';?>" method="POST">
                    ...
                    <div class="row">
                      <div class="form-group col-12 col-lg-6">
                         ...
                         <input type="text" value="<?php echo set_value('host_name'); ?>" name="host_name" required class="form-control col-xs-12"  placeholder="Host Name *">          
                      </div>
                      <div class="form-group col-12 col-lg-6">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-12 col-lg-6">
                         ...
                         <input type="password" value="<?php echo set_value('database_password'); ?>" name="database_password" class="form-control col-xs-12"  placeholder="Database Password ">          
                      </div>
                    </div>
                     ...
                     <div class="row">
                       ...
                       <div class="form-group col-12 col-lg-6">
                          ...
                          <input type="password" name="app_password" value="<?php echo set_value('app_password'); ?>" required class="form-control col-xs-12"  placeholder="Application Password *">          
                       </div>
                     </div>
