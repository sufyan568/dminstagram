                ...
                <div class="modal-body" id="auto_reply_message_modal_body">
                    ...
                    <div class="row padding_10_20_10_20px <?php if(!$commnet_hide_delete_addon) echo "d_none";?>">
                        ...
                        <div class="col-12 col-md-6 d_none">
                            <div class="form-group instagram_border_padded">
                                ...
                                <textarea class="form-control message height_100px" name="private_message_offensive_words" id="private_message_offensive_words" placeholder="<?php echo $this->lang->line("type your comment reply here...Keep it blank for no actions") ?>"></textarea>                                
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body" id="edit_auto_reply_message_modal_body">
                    ...
                    <div class="row padding_10_20_10_20px">
                        ...
                        <div class="col-12 d_none" id="edit_filter_message_div">
                            <?php for ($i = 1; $i <= 20; $i++) : ?>
                                <div class="form-group instagram_border_padded2" id="edit_filter_div_<?php echo $i; ?>">
                                    <label>
