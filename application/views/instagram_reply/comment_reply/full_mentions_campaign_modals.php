                    ...
                    <div class="row padding_10_20_10_20px">
                        ...
                        <div class="col-12 d_none" id="full_filter_message_div">
                            ...
                            <?php for ($i = 1; $i <= 20; $i++) : ?>
                                ...
                                <div class="form-group instagram_border_margined_padded2" id="full_filter_div_<?php echo $i; ?>">
                ...
                <div class="row padding_10_20_10_20px">
                    ...
                    <div class="col-12 d_none" id="full_edit_filter_message_div">
                        ...
                        <?php for ($i = 1; $i <= 20; $i++) : ?>
                            ...
                            <div class="form-group instagram_border_margined_padded2" id="full_edit_filter_div_<?php echo $i; ?>">
                    ...
                    <div class="row padding_10_20_10_20px">
                        ...
                        <div class="col-12 d_none" id="mentions_filter_message_div">
                            ...
                            <?php for ($i = 1; $i <= 20; $i++) : ?>
                                ...
                                <div class="form-group instagram_border_margined_padded2" id="mentions_filter_div_<?php echo $i; ?>">
                ...
                <div class="row padding_10_20_10_20px">
                    ...
                    <div class="col-12 d_none" id="mentions_edit_filter_message_div">
                        ...
                        <?php for ($i = 1; $i <= 20; $i++) : ?>
                            ...
                            <div class="form-group instagram_border_margined_padded2" id="mentions_edit_filter_div_<?php echo $i; ?>">
