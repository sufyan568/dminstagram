...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.account_switch', function(e) {
      e.preventDefault();
...
<script type="text/javascript">
  ...
  $(document).ready(function() { 
    ...
    var is_mobile =  '<?php echo $this->session->userdata("is_mobile");?>';
      ...
      if(is_mobile=='0' && ( (controller_name=="instagram_poster" && (function_name=="image_video_poster" || function_name=="image_video_edit_auto_post")) ))
