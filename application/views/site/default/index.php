...
Version: 1.0
Description: This is a default theme provided by the Author of XeroIni. We highly recommend not to change core files for your customization needs. For your own customization, create your own theme as per our <a href="https://xeroneit.net/blog/xerochat-front-end-theme-development-manual" target="_BLANK">documentation</a>. 
*/
?>
<!doctype html>
...
<head>
	...
	<!--====== Tiny slider CSS ======-->
	<link rel="stylesheet" href="<?php echo base_url('assets/site/css/tiny-slider.css');?>">

	<!--====== Swiper slider css ======-->
	<link rel="stylesheet" href="<?php echo base_url('assets/site/css/swiper.min.css');?>">

	<!--====== Glightbox CSS ======-->
	<link rel="stylesheet" href="<?php echo base_url('assets/site/css/glightbox.min.css');?>">

	<!--====== Line Icons CSS ======-->
	<link rel="stylesheet" href="<?php echo base_url('assets/site/css/LineIcons.2.0.css');?>">

	<!--====== Bootstrap CSS ======-->
	<link rel="stylesheet" href="<?php echo base_url('assets/site/css/bootstrap-5.0.5-alpha.min.css');?>">
...
<body>
			...
			<div class="row align-items-center">
				<div class="col-xl-6 col-lg-6">
					<div class="hero-content">
						...
						<h3 class="wow fadeInUp" data-wow-delay=".2s"> <?php echo $this->lang->line("Developed using Instagram official API"); ?></h3><br>
						...
						<div class="hero-btns">
							...
							<?php 
							 ...
							 ?>
							<a href="#" class="watch-btn glightbox wow fadeInUp <?php if($this->config->item('display_video_block') == '0' || $this->config->item('promo_video') == '') echo 'd-none';?>" data-wow-delay=".5s"> <i class="lni lni-play"></i> <span><?php echo $this->lang->line("Quick Video"); ?></span></a>
						</div>
					</div>
				</div>
				<div class="col-xl-6 col-lg-6">
					<div class="hero-img">
						<img src="<?php echo base_url();?>assets/site/images/features-image-2.png" alt="" class="wow fadeInRight" data-wow-delay=".2s">
						<img src="<?php echo base_url();?>assets/site/images/features-image-1.png" alt="" class="img-screen screen-1 wow fadeInUp" data-wow-delay=".25s">
						<img src="<?php echo base_url();?>assets/site/images/features-image-2.png" alt="" class="img-screen screen-2 wow fadeInUp" data-wow-delay=".3s">
						<img src="<?php echo base_url();?>assets/site/images/features-image-2.png" alt="" class="img-screen screen-3 wow fadeInUp" data-wow-delay=".35s">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-xl-3 col-lg-3 col-md-6">
					<div class="single-feature item-1 wow fadeInUp" data-wow-delay=".2s">
						...
						<div class="feature-content">
							<h4><?php echo $this->lang->line("Image/Video Posting"); ?></h4>
							<p><?php echo $this->lang->line("Instant posting, post scheduling, periodic post, image editor"); ?></p>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-6">
					<div class="single-feature item-2 wow fadeInUp" data-wow-delay=".4s">
						...
						<div class="feature-content">
							<h4><?php echo $this->lang->line("Comment on Post"); ?></h4>
							<p><?php echo $this->lang->line("Template, random/serial comment, periodic comment"); ?></p>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-6">
					<div class="single-feature item-3 wow fadeInUp" data-wow-delay=".6s">
						...
						<div class="feature-content">
							...
							<p><?php echo $this->lang->line("Template, hide/delete offensive comment, keyword based reply, mention reply"); ?></p>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-6">
					<div class="single-feature item-4 wow fadeInUp" data-wow-delay=".8s">
						...
						<div class="feature-content">
							<h4><?php echo $this->lang->line("Hash Tag Search"); ?></h4>
							<p><?php echo $this->lang->line("Search by keyword, display media, display love/comment"); ?></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xl-5 col-lg-6">
					<div class="how-work-img text-center text-lg-left">
						<img src="<?php echo base_url();?>assets/site/images/download-img.png" alt="" class="w-100 wow fadeInLeft img-fluid" data-wow-delay=".2s">
						<img src="<?php echo base_url();?>assets/site/images/dots-shape.svg" alt="" class="shape dots-shape wow fadeInUp" data-wow-delay=".3s">
					</div>
				</div>
				<div class="col-xl-6 offset-xl-1 col-lg-6">
					<div class="how-work-content-wrapper">
						<div class="section-title">
							...
							<p class="mb-35 wow fadeInUp" data-wow-delay=".3s"><?php echo $this->lang->line("Few steps to connect your Instagram account and make this app work.");?></p>
						</div>
							...
							<div class="accordion" id="accordionExample">
								<div class="single-accordion mb-30 wow fadeInUp" data-wow-delay=".2s">
									<div class="accordion-btn">
										<button class="btn-block text-left collapsed" type="button" data-toggle="collapse"
											...
											<span><?php echo $this->lang->line("Connect Instagram account"); ?></span>
										</button>
									</div>

									<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
										<div class="accordion-content">
											<?php echo $this->lang->line("Connect Instagram account is just few clicks easy. Clicking 'Login with Facebook' button will prompt you to allow access to import your Instagram account and you are ready to go."); ?>
										</div>
									</div>
								</div>
								<div class="single-accordion mb-30 wow fadeInUp" data-wow-delay=".3s">
									...
									<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
										<div class="accordion-content">
											<?php echo $this->lang->line("Just upload image/video media you want to post. Editing image using a full-featured aweosme image editor is available. You can write a caption in addition. Now post it or schedule it to post later. You can also set scheduled periodic post to post same content periodically."); ?>
										</div>
									</div>
								</div>
								<div class="single-accordion mb-30 wow fadeInUp" data-wow-delay=".4s">
									<div class="accordion-btn">
										<button class="btn-block text-left collapsed" type="button" data-toggle="collapse"
											...
											<span><?php echo $this->lang->line("Create Comment on Post"); ?></span>
										</button>
									</div>
								...
								<div class="single-accordion mb-30 wow fadeInUp" data-wow-delay=".4s">
									...
									<div id="collapseFour" class="collapse" aria-labelledby="headingThree"
										data-parent="#accordionExample">
										<div class="accordion-content">
											<?php echo $this->lang->line("Reply automatically your Instram post based on comment content. You can also hide/delete any offensive comments. Mentioning in reply is also available. You can save your replies as template and use it whenever you want."); ?>
										</div>
									</div>
								</div>
							</div>
	...
	<section id="tutorial" class="video-area pt-130 <?php if($this->config->item('display_video_block') == '0' || $this->config->item('promo_video') == '') echo 'd-none';?>">
		<div class="container">
			...
			<div class="video-frame wow fadeInUp" data-wow-delay=".4s">
				<img src="<?php echo base_url();?>assets/site/images/video-frame.png" alt="">
	...
	<section id="screenshots" class="screenshot-area-wrapper pt-50">
		<div class="screenshot-area pt-90 pb-90">
			<div class="shapes">
				<img src="<?php echo base_url();?>assets/site/images/ss-line.svg" alt="" class="line-shape-1 shape">
				<img src="<?php echo base_url();?>assets/site/images/ss-line.svg" alt="" class="line-shape-2 shape">
			</div>
			<div class="container">
				<div class="row">
				...
				<div class="screenshot-slider-wrapper swiper-container">
					<div class="screenshot-slider swiper-wrapper">
						<div class="single-screen swiper-slide">
							<img src="<?php echo base_url();?>assets/site/images/screen-1.png" alt="">
						</div>
						<div class="single-screen swiper-slide">
							<img src="<?php echo base_url();?>assets/site/images/screen-2.png" alt="">
						</div>
						<div class="single-screen swiper-slide">
							<img src="<?php echo base_url();?>assets/site/images/screen-3.png" alt="">
						</div>
						<div class="single-screen swiper-slide">
							<img src="<?php echo base_url();?>assets/site/images/screen-4.png" alt="">
						</div>
						<div class="single-screen swiper-slide">
							<img src="<?php echo base_url();?>assets/site/images/screen-5.png" alt="">
						</div>
					</div>
					<div class="screenshot-frame">
						<img src="<?php echo base_url();?>assets/site/images/screen-active.png" alt="">
					</div>
	...
	<section class="testimonial-area pt-150 <?php if($this->config->item('display_review_block') == '0') echo 'd-none';?>">
		<div class="container">
			<div class="row">
			...
			<div class="row">
				<div class="col-xl-6 col-lg-8 col-md-10 mx-auto">
					<div class="section-title text-center">
						...
						<p class="mb-50 wow fadeInUp"><?php echo $this->lang->line("Complete marketing software for Instagram in very reasonable price");?></p>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="row">
					...
					<div class="col-xl-5 align-self-end col-lg-5 col-11 offset-1 offset-lg-0">
						<div class="download-img wow fadeInRight" data-wow-delay=".2s">
							<img src="<?php echo base_url();?>assets/site/images/cta-right-img.png" alt="" class="img-fluid">
						</div>
					</div>
				</div>
			</div>
	...
	<!--====== jQuery js ======-->
	<script src="<?php echo base_url('assets/site/js/jquery-1.12.4.min.js');?>"></script>

	<!--====== Bootstrap js ======-->
	<script src="<?php echo base_url('assets/site/js/bootstrap.bundle-5.0.0.alpha-min.js');?>"></script>

	<!--====== Tiny slider js ======-->
	<script src="<?php echo base_url('assets/site/js/tiny-slider.js');?>"></script>

	<!--====== Swiper slider js ======-->
	<script src="<?php echo base_url('assets/site/js/swiper.min.js');?>"></script>

	<!--====== glightbox js ======-->
	<script src="<?php echo base_url('assets/site/js/glightbox.min.js');?>"></script>

	<!--====== wow js ======-->
	<script src="<?php echo base_url('assets/site/js/wow.min.js');?>"></script>

	<!--====== count-up js ======-->
	<script src="<?php echo base_url('assets/site/js/count-up.min.js');?>"></script>

	<!--====== contact form js ======-->
	<script src="<?php echo base_url('assets/site/js/contact-form.js');?>"></script>
